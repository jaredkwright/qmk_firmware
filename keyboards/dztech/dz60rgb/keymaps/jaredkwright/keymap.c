...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		[_LAYER1] = LAYOUT_ANSI( /* FN */
			    ...
			    KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_TRNS,  KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT,  KC_HOME,  KC_PGUP,            KC_TRNS,\
		...
		[_LAYER2] = LAYOUT_ANSI( /* FN2 */
				...
				KC_CAPS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  RGB_SPI,  RGB_SPD,  KC_TRNS,  KC_TRNS,            KC_TRNS,\
...
void rgb_matrix_indicators_user(void) {
	  ...
	  if (!g_suspend_state) {
	    switch (biton32(layer_state)) {
	      ...
	      case _LAYER2:
	        rgb_matrix_layer_helper(0xFF, 0x99, 0x33, false); break;
	    							  }
	                        }
